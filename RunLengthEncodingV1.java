    ...
    // Replace the following line with your solution.
      ...
      while (iter.hasNext()) {
          ...
          for (int i = 0; i < ints[0]; i++) {
              //System.out.println("array length: " + tempPixel.length);
  ...
  public static void main(String[] args) {
    ...
    for (int j = 0; j < image1.getHeight(); j++) {
      for (int i = 0; i < image1.getWidth(); i++) {
        System.out.print(image1.getRed(i,j)+"/");
        System.out.print(image1.getGreen(i,j)+"/");
        System.out.print(image1.getBlue(i,j)+",");
      }
      System.out.println(" ");
    }
    System.out.println(" ");
    ...
    //PixImage x = rle1.toPixImage();
    //doTest(x.equals(image1),
